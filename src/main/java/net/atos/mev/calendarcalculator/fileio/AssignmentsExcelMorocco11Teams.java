...
public class AssignmentsExcelMorocco11Teams {
	...
	int nTournaments;
	Environment env;
	int[][] roundStarts = { { 6, 0 }, { 6, 2 }, { 6, 4 }, { 6, 6 }, { 6, 8 }, 
			{ 14, 0 }, { 14, 2 }, { 14, 4 }, { 14, 6 }, { 14, 8 }, 
			{ 22, 0 },  
			{ 6, 11 }, { 6, 13 }, { 6, 15 }, { 6, 17 }, { 6, 19 }, 
			{ 14, 11 }, { 14, 13 }, { 14, 15 }, { 14, 17 }, { 14, 19 },
			{ 22, 11 }, };
	public AssignmentsExcelMorocco11Teams(String environment, String assignFolder, String templatePath, int nTournaments) {
	...
	public static void loadFromConfig(String configFile) {
		try {
			...
			AssignmentsExcelMorocco11Teams execution = new AssignmentsExcelMorocco11Teams(environment, assignFolder, templatePath, nTournaments);
			execution.execute();
		} catch (Exception e) {
			e.printStackTrace();
		}
