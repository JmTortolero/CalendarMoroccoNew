...
public class LimitAgainstTeamsInRoundsHomeCheck implements Check {
	...
	public LimitAgainstTeamsInRoundsHomeCheck(int limit, Team[] teams, int[] roundsOfMatches) {
...
//				System.out.println("------ Team " + nTeam + ", foundMatches="+foundMatches);
	...
	public static void main(String[] args) {
		...
		int[] rounds1 = {2,3};
		int[] rounds2 = {2,4};
		LimitAgainstTeamsInRoundsHomeCheck checker1 = new LimitAgainstTeamsInRoundsHomeCheck(1, pair1, rounds1);
		LimitAgainstTeamsInRoundsHomeCheck checker2 = new LimitAgainstTeamsInRoundsHomeCheck(1, pair1, rounds2);
		LimitAgainstTeamsInRoundsHomeCheck checker3 = new LimitAgainstTeamsInRoundsHomeCheck(2, pair1, rounds1);
		LimitAgainstTeamsInRoundsHomeCheck checker4 = new LimitAgainstTeamsInRoundsHomeCheck(2, pair1, rounds2);
		System.out.println("LimitAgainstTeamsInRoundsHomeCheck t1=" + checker1.check(t1));
		System.out.println("LimitAgainstTeamsInRoundsHomeCheck t2=" + checker2.check(t1));
		System.out.println("LimitAgainstTeamsInRoundsHomeCheck t3=" + checker3.check(t1));
		System.out.println("LimitAgainstTeamsInRoundsHomeCheck t4=" + checker4.check(t1));
